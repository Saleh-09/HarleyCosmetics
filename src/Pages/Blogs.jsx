            ...
            <div className="space-y-12">
                ...
                {blogPosts.map((post) => (
                    ...
                    <div className="aspect-video overflow-hidden relative group">
                        ...
                        />
                        <Link href={`/blog/${post.id}`} className="absolute bottom-4 right-4">
                        <Button className="bg-white text-black hover:bg-gray-50 shadow-lg border-0 rounded-full px-4 py-2 font-medium group">
                            Read more
                    ...
                    <CardContent className="p-6 space-y-4">
                        ...
                        <h2 className="text-xl font-semibold text-foreground leading-tight">{post.title}</h2>
